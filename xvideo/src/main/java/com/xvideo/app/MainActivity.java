...
public class MainActivity extends Activity {
    ...
    private static final String FILTER_JS = "javascript:(function(){" +
        "if(window.__xv6)return;window.__xv6=1;" +
        ...
        ".xv-play{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:2147483646;width:72px;height:72px;border-radius:50%;border:1px solid rgba(255,255,255,.25);background:rgba(8,8,10,.72);color:#fff;font-size:30px;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(12px);box-shadow:0 8px 28px rgba(0,0,0,.35);}" +
        ".xv-play.xv-playing{opacity:.18;transition:opacity .18s}.xv-play.xv-playing:hover{opacity:.75;}" +
